...
export function nice(bin: string): string;

export function nice6(bin: string): string;

export function nicePart6(bin: string): string;

export function nice4(bin: string): string;

export function nicePart4(bin: string): string;
